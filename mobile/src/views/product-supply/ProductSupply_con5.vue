...
<!-- 
              ...
              <van-collapse v-model="activeNames_tips" accordion>
                <van-collapse-item title="总库存" name="1">
                  <p>佛山仓库+青岛仓库+成都仓库+供应商库存+小商品成品仓+展厅展会</p>
                  <p>①佛山仓库/青岛仓库/成都仓库：成品仓库存账期报表（库存数/成本货值）</p>
                  <p>②供应商库存：检验账期 = 当前日期 - 质检完成日期，库存数=检验单的未入库数量（库存数/成本货值）</p>
                  <p>③检验库龄：取检验时间至统计日期的天数</p>

                </van-collapse-item>

                <van-collapse-item title="林氏仓库存" name="2">
                  <p>佛山仓库存+青岛仓库存+成都仓库+小商品成品仓+展厅展会</p>
                  <p>①佛山仓库/青岛仓库/成都仓库：成品仓库存账期报表（库存数/成本货值）</p>
                  <p>②检验库龄：取检验时间至统计日期的天数</p>
                </van-collapse-item>

                <van-collapse-item title="供方仓库存" name="3">
                  <p>供应商库存</p>
                  <p>①供应商库存：检验账期 = 当前日期 - 质检完成日期，库存数=检验单的未入库数量（库存数/成本货值）</p>
                  <p>②检验库龄：取检验时间至统计日期的天数。</p>
                </van-collapse-item>

                <van-collapse-item title="在途金额" name="4">
                  <p>在途数=(采购数-累计合格数)*平均采购价。</p>
                </van-collapse-item>

                <van-collapse-item title="报检金额" name="5">
                  <p>检验单单据状态=已审核，作废状态=未作废的含税金额。</p>
                </van-collapse-item>
        ...
        >
          ...
          >
            <div
              @click="
                Single_choice('all_muri_value', ['_this.data_screen_quota()','_this.initChart()','_this.initChart2()','_this.echarts_clear=true'], 1, '_this.sel_value.target')
              "
            ...
            <div
              @click="
                Single_choice('all_muri_value', ['_this.data_screen_quota()','_this.initChart()','_this.initChart2()','_this.echarts_clear=true'], 2, '_this.sel_value.target')
              "
            ...
            <div
              @click="
                Single_choice('all_muri_value', ['_this.data_screen_quota()','_this.initChart()','_this.initChart2()','_this.echarts_clear=true'], 3, '_this.sel_value.target')
              "
        ...
        <van-row
          ...
          v-if="sel_value.target.all_muri_value==2"
        >
          <van-col
            span="5"
            @click="
            ...
            style="margin-right: 1.5%; border-radius: 4px; margin-left: 1.5%;"
          >
          ...
          <van-col
            ...
            "
            :style="
              sel_value.qudao_guanjan.qudao_guanj_pd == '4'
                ? whole_css.qudao_guanjan: whole_css.qudao_guanjan_n"
            style="margin-right: 1.5%; border-radius: 4px;"
          >
          ...
          <van-col
            ...
            "
            :style="
              sel_value.qudao_guanjan.qudao_guanj_pd == '5'
                ? whole_css.qudao_guanjan: whole_css.qudao_guanjan_n"
            style="margin-right: 0px; border-radius: 4px;"
          >
        ...
        <div
          ...
          >
            ...
            {{sel_value.target.all_muri_value == 1? '在途报检':'库龄分层(不剔除未发订单)'}}
          </div>
        </section>
          ...
          <section class="px10 py10" :style="(sel_value.Range_on.Range_set=='2'||sel_value.Range_on.Range_set=='5')? echarts2_css_n : echarts2_css_y">
            <ul class="table_all">
              ...
              >
                ...
                <ul>
                  <li>{{nll_undefined(val.TEAM_SUPPLY)}}</li>
                  <li>{{
                    (sel_value.Range_on.Range_set=='4')? 
                  ...
                  >
                    ...
                    {{nll_undefined(((val.NEW_PROD_AMT_CPML_RTO||0)*100).toFixed(2))+'%'}}
...
export default {
  ...
  created() {
    ...
    const apiMap = {
      ...
      // 核心指标
      // 售后==品质
      // "SQL-pds_afs-diff_afs_bad_rto": { resultProp: "diff_afs_bad_rto" },
      // "SQL-pds_afs-tgt_afs_bad_rto": { resultProp: "tgt_afs_bad_rto" },
      // "SQL-pds_afs-afs_bad_rto_yoy": { resultProp: "afs_bad_rto_yoy" },
      // "SQL-pds_afs-factory_bad_rto": { resultProp: "factory_bad_rto" },
      // "SQL-pds_afs-afs_bad_rto": { resultProp: "afs_bad_rto" },
      // "SQL-pds_afs-lgs_bad_rto": { resultProp: "lgs_bad_rto" },
      // "SQL-pds_afs-pds_afs_tot": { resultProp: "pds_afs_tot" },
      // "SQL-pds_afs-mons_afs_rto": { resultProp: "mons_afs_rto" },
      // "SQL-pds_afs-spl_afs_rto": { resultProp: "spl_afs_rto" },



      //库存
      // "SQL-pds_kpi-kpi_fields": { resultProp: "kpi_fields" },
      // "SQL-pds_inv-spl_inv_amt": { resultProp: "spl_inv_amt" },  //没用到的了
      "SQL-pds_inv-rem_inv_lvl": { resultProp: "rem_inv_lvl" },
      "SQL-pds_inv-intrns_amt": { resultProp: "intrns_amt" },
      // "SQL-pds_inv-tot_inv_amt": { resultProp: "tot_inv_amt" },   //没有到的了
      // "SQL-pds_inv-tot_inv_amt_yoy": { resultProp: "tot_inv_amt_yoy" },  //没用到的了
      // "SQL-pds_inv-max_tot_inv_amt": { resultProp: "max_tot_inv_amt" }, //没用到的了
      // "SQL-pds_inv-diff_tot_inv_amt": { resultProp: "diff_tot_inv_amt" },  //没用到的了
      // "SQL-pds_inv-linsy_inv_amt": { resultProp: "linsy_inv_amt" },  //没用到的了
      // "SQL-pds_inv-mons_inv_amt": { resultProp: "mons_inv_amt" },

      // "SQL-pds_inv-": { resultProp: "mons_inv_amt" },

      "SQL-pds_inv-mons_inv_amt": { type: Array, resolve2: resolve2 },
      "SQL-pds_kpi-kpi_fields": { type: Array, resolve: resolve1 },
      

      // 新品
      // "SQL-pds_new_prod-new_prod_amt_yoy": { resultProp: "new_prod_amt_yoy" },
      // "SQL-pds_new_prod-tgt_act_price": { resultProp: "tgt_act_price" },
      // "SQL-pds_new_prod-pure_new_prod_amt": { resultProp: "pure_new_prod_amt" },
      // "SQL-pds_new_prod-lvlup_act_price": { resultProp: "lvlup_act_price" },
      // "SQL-pds_new_prod-pure_new_act_price": { resultProp: "pure_new_act_price" },
      // "SQL-pds_new_prod-new_prod_amt_cpml_rto": { resultProp: "new_prod_amt_cpml_rto" },
      // "SQL-pds_new_prod-new_prod_tot_amt": { resultProp: "new_prod_tot_amt" },
      // "SQL-pds_new_prod-new_prod_amt_days": { resultProp: "new_prod_amt_days" },
      // "SQL-pds_new_prod-spl_new_prod": { resultProp: "spl_new_prod" },
      ...
      //欠货
      // "SQL-pds_shrt-shrt_days": { resultProp: "shrt_days" },
      // "SQL-pds_shrt-shrt_spl": { type: Array, resolve: resolve1 },
  ...
  mounted() {
    ...
    this.$EventBus.$on("prosupply_choice_f", (Range_value_set) => {
      ...
      switch (Range_value_set.Range_value_set) {
        ...
        case "2":
          ...
          Information_log('产品供应-库存','产品供应-库存:  '+'数据加载完成'); 
    ...
    this.Single_choice('cpcy', ['_this.change_text(\''+'2'+'\')'], true, '_this.sel_value.theme');
      ...
      this.p1.then(() => {
        ...
        try{
            ...
            Object.keys(user_data).forEach((key_value_chart) => {
              if(this.sel_value.target.all_muri_value==1){
                ...
                if(this.sel_value.qudao_guanjan.qudao_guanj_pd==1){
                  if(user_data[key_value_chart].MDATE.substring(0,4)*1==year_now){
                    sale_amt.push(((user_data[key_value_chart].LINSY_INV_AMT==0)?null:(user_data[key_value_chart].LINSY_INV_AMT/10000/10000).toFixed(2)*1));
                  }else if(user_data[key_value_chart].MDATE.substring(0,4)*1==(year_now-1)){
                  ...
                  if(user_data[key_value_chart].MDATE.substring(0,4)*1==year_now){
                    sale_amt.push(((user_data[key_value_chart].FS_SPL_INV_AMT==0)?null:(user_data[key_value_chart].FS_SPL_INV_AMT/10000/10000).toFixed(2)*1));
                  }else if(user_data[key_value_chart].MDATE.substring(0,4)*1==(year_now-1)){
                    ago_amt.push((user_data[key_value_chart].FS_SPL_INV_AMT/10000/10000).toFixed(2)*1);
                    hour_data.push((user_data[key_value_chart].MDATE.substring(5, 7)*1+'月'));
                  }  
                }else if(this.sel_value.qudao_guanjan.qudao_guanj_pd==3){
                  if(user_data[key_value_chart].MDATE.substring(0,4)*1==year_now){
                    sale_amt.push(((user_data[key_value_chart].QD_SPL_INV_AMT==0)?null:(user_data[key_value_chart].QD_SPL_INV_AMT/10000/10000).toFixed(2)*1));
                  }else if(user_data[key_value_chart].MDATE.substring(0,4)*1==(year_now-1)){
                    ago_amt.push((user_data[key_value_chart].QD_SPL_INV_AMT/10000/10000).toFixed(2)*1);
                    hour_data.push((user_data[key_value_chart].MDATE.substring(5, 7)*1+'月'));
                  }
                }else if(this.sel_value.qudao_guanjan.qudao_guanj_pd==4){
                  if(user_data[key_value_chart].MDATE.substring(0,4)*1==year_now){
                    sale_amt.push(((user_data[key_value_chart].CD_SPL_INV_AMT==0)?null:(user_data[key_value_chart].CD_SPL_INV_AMT/10000/10000).toFixed(2)*1));
                  }else if(user_data[key_value_chart].MDATE.substring(0,4)*1==(year_now-1)){
                    ago_amt.push((user_data[key_value_chart].CD_SPL_INV_AMT/10000/10000).toFixed(2)*1);
                    hour_data.push((user_data[key_value_chart].MDATE.substring(5, 7)*1+'月'));
                  }                  
                }else if(this.sel_value.qudao_guanjan.qudao_guanj_pd==5){
                  if(user_data[key_value_chart].MDATE.substring(0,4)*1==year_now){
                    sale_amt.push(((user_data[key_value_chart].SHG_SPL_INV_AMT==0)?null:(user_data[key_value_chart].SHG_SPL_INV_AMT/10000/10000).toFixed(2)*1));
                  }else if(user_data[key_value_chart].MDATE.substring(0,4)*1==(year_now-1)){
                    ago_amt.push((user_data[key_value_chart].SHG_SPL_INV_AMT/10000/10000).toFixed(2)*1);
                    hour_data.push((user_data[key_value_chart].MDATE.substring(5, 7)*1+'月'));
                  } 
                }
          ...
          if(this.sel_value.Range_on.Range_set == "1"){
            ...
            Object.keys(hour_data).forEach((key_mv) => {
              if(hour_data[key_mv]==((_time_now.getMonth()+1)+'月')){
                this.barData.value=(sale_amt[key_mv]==null)?'--':this.fomatMoney(sale_amt[key_mv])+'亿'
                this.barData.ago_value=(ago_amt[key_mv]==null)?'--':this.fomatMoney(ago_amt[key_mv])+'亿'
              }
            });  
              ...
              tooltip: {
                ...
                formatter:function (params) {
                  ...
                  if(_this.sel_value.Range_on.Range_set=='1'){
                    ...
                    _this.barData.value =(params[1]==undefined||params[1].value==null)? '--':_this.fomatMoney((params[1].value).toFixed(2))+'亿';
                    _this.barData.ago_value =(params[0]==undefined||params[0].value==null)? '--': _this.fomatMoney((params[0].value).toFixed(2))+'亿';
                    // _this.barData.month =(params[0]==undefined)? 0: params[0].axisValue;
                    _this.barData.month =(params[0]==undefined||params[0].axisValue==null)? 0: year_now+'.'+((params[0].axisValue).replace(/[^0-9]/ig,"")>9?(params[0].axisValue).replace(/[^0-9]/ig,""):'0'+(params[0].axisValue).replace(/[^0-9]/ig,""));
          ...
          console.error(error);
          // this.info_error+=1;
          Information_log('产品供应-库存','产品供应-库存-折线图:  '+error.toString());
        }
        ...
        try{
          ...
          if(this.sel_value.target.all_muri_value==1){
            ...
            Object.keys(user_data).forEach((key_value_chart2) => {
              zai_tu_amt.push(((user_data[key_value_chart2].INTRNS_AMT)/10000).toFixed(4)*1);
              bao_jian_amt.push(((user_data[key_value_chart2].WAIT_INSP_AMT)/10000).toFixed(4)*1);
            ...
            Object.keys(user_data).forEach((key_value_chart2) => {
              ...
              if(user_data[key_value_chart2].INV_AGE_LVL=='91-180'){
                data_91.push((user_data[key_value_chart2].LINSY_INV_AMT/10000).toFixed(4)*1);
                hour_data.push(user_data[key_value_chart2].MDATE.substring(0,7));
              }else if(user_data[key_value_chart2].INV_AGE_LVL=='181-360'){
                data_181.push((user_data[key_value_chart2].LINSY_INV_AMT/10000).toFixed(4)*1);
              }else if(user_data[key_value_chart2].INV_AGE_LVL=='361-720'){
                data_361.push(((user_data[key_value_chart2].LINSY_INV_AMT)/10000).toFixed(4)*1);
              }else if(user_data[key_value_chart2].INV_AGE_LVL=='720+'){
                data_720.push((user_data[key_value_chart2].LINSY_INV_AMT/10000).toFixed(4)*1);
              }
            ...
            Object.keys(user_data).forEach((key_value_chart2) => {
              ...
              // if(user_data[key_value_chart2].MDATE.substring(0,4)*1==year_now){}
                ...
                if(user_data[key_value_chart2].INV_AGE_LVL=='91-180'){
                  data_91.push((user_data[key_value_chart2].SPL_INV_AMT/10000).toFixed(4)*1);
                  // hour_data.push((user_data[key_value_chart2].MDATE.substring(5, 7)*1+'月'));
                  hour_data.push(user_data[key_value_chart2].MDATE.substring(0,7));
                }else if(user_data[key_value_chart2].INV_AGE_LVL=='181-360'){
                  data_181.push((user_data[key_value_chart2].SPL_INV_AMT/10000).toFixed(4)*1);
                }else if(user_data[key_value_chart2].INV_AGE_LVL=='361-720'){
                  data_361.push(((user_data[key_value_chart2].SPL_INV_AMT)/10000).toFixed(4)*1);
                }else if(user_data[key_value_chart2].INV_AGE_LVL=='720+'){
                  data_720.push((user_data[key_value_chart2].SPL_INV_AMT/10000).toFixed(4)*1);
                }
            ...
            tooltip: {
              ...
              formatter:function (params) {
                ...
                if(_this.sel_value.target.all_muri_value==1){
                  ...
                  // console.log(params);
                  user_data_params="月份："+params[0].axisValue+'<br/> 在途：'+params[0].marker+(_this.fomatMoney(params[0].value.toFixed(1)))+'万<br/> 报检：'+params[1].marker+(_this.fomatMoney(params[1].value.toFixed(1)))+'万';
                  ...
                  '<br/> 91-180：'+params[0].marker+_this.fomatMoney(params[0].value.toFixed(1))+
                  '万<br/> 181-360：'+params[1].marker+_this.fomatMoney(params[1].value.toFixed(1))+
                  '万<br/> 361-720：'+params[2].marker+_this.fomatMoney(params[2].value.toFixed(1))+
                  '万<br/> 720+：'+params[3].marker+_this.fomatMoney(params[3].value.toFixed(1))+'万';
...
/deep/ .zaitu_css div.van-row div.van-col--5{
  width: 18%;
}
