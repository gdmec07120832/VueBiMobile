          ...
          <van-popup v-model="question_show" @close='showPopup_close' class="popup_css" get-container="body">
            ...
            <div style="text-align: left;font-size: 14px;padding-left: 20px;
              ...
              <van-collapse v-model="activeNames_tips" accordion>
                <van-collapse-item title="SKU均值（汇总）" name="1">
                  <p>计算公式：发货业绩/发货数</p>
                  <p>{{'①发货数：类目≠不考核/软货，是否统计=是，发货业绩>0'}}</p>
                  <p>{{'②发货业绩：类目≠不考核/软货。'}}</p>
                </van-collapse-item>
                <van-collapse-item title="SKU均值（非停产）" name="2">
                  <p>计算公式：发货业绩/发货数</p>
                  <p>①发货数：类目≠不考核/软货，是否统计=是，发货业绩>0</p>
                  <p>②发货业绩：类目≠不考核/软货，是否停产=否</p>
                </van-collapse-item>
                <van-collapse-item title="SKU均值（停产）" name="3">
                  <p>计算公式：发货业绩/发货数</p>
                  <p>①发货数：类目≠不考核/软货，是否统计=是，发货业绩>0；</p>
                  <p>②发货业绩：类目≠不考核/软货，是否停产=是。</p>
                </van-collapse-item>

                <van-collapse-item title="SKU均值（新品）" name="4">
                  <p>计算公式：新品发货业绩/新品发货数</p>
                  <p>①发货数：类目≠不考核/软货，是否统计=是，发货业绩>0</p>
                  <p>②发货业绩：类目≠不考核/软货</p>
                  <p>③新品定义：统计年份上架的单品升级性质=原始产品的sku</p>
                </van-collapse-item>

                <van-collapse-item title="SKU均值（旧品）" name="5">
                  <p>计算公式：旧品发货业绩/旧品发货数</p>
                  <p>①发货数：类目≠不考核/软货，是否统计=是，发货业绩>0</p>
                  <p>②发货业绩：类目≠不考核/软货</p>
                </van-collapse-item>
                      ...
                      <span class="tongbi_css" :style="sum_zhibiao.body">
                        ...
                        >
                          {{
                            ...
                            (sel_title_setvalue.quota_value.cont3/10000).toFixed(1)+'万'
                            :
                            (sel_title_setvalue.quota_value.cont3*100).toFixed(1)+'%'
              ...
              <swiper  ref="mySwiper_entry" :options="swiperOptions">
                <template>
                  ...
                  <swiper-slide >
                    ...
                    <div
                      @click="
                        Single_choice('all_muri_value', ['_this.data_screen_quota()','_this.initChart()','_this.echarts_clear=true'], 4, '_this.sel_value.target')
                      "
                      class="Productmarket_labqie_con1"
                      :style="
                      ...
                      "
                    >
                      <span :class="sel_value.target.all_muri_value == 4? 'title_change':''" :style="sum_zhibiao.title">{{
                        sel_title.chanzhi_wenzi.title_newpro
                      }}</span>

                      <span :style="sum_zhibiao.zhognxin"> 
                        {{
                          (sel_title_setvalue.quota_value.cont10==undefined)?'--'
                          :nll_undefined(fomatMoney((sel_title_setvalue.quota_value.cont10/10000).toFixed(1)))+'万'
                        }}
                      </span>
                      ...
                      <span :style="sum_zhibiao.body">
                        ...
                        > 
                          {{(sel_title_setvalue.quota_value.cont11==undefined||sel_title_setvalue.quota_value.cont11==0)? '--':
                          nll_undefined((sel_title_setvalue.quota_value.cont11/10000).toFixed(1))+'万'}} 
                          </i>
                      </span>
                      <span class="tongbi_css" :style="sum_zhibiao.body">
                        ...
                        <i 
                        style="font-style: normal;padding-left: 3px;"
                          :class="Number(sel_title_setvalue.quota_value.cont12) > 0? 'rate-up': 'rate-down'"
                        >
                          {{(sel_title_setvalue.quota_value.cont12*100).toFixed(1)+'%'}}</i>
                      </span>
                    </div>

                    <div
                      @click="
                        Single_choice('all_muri_value', ['_this.data_screen_quota()','_this.initChart()','_this.echarts_clear=true'], 5, '_this.sel_value.target')
                      "
                      class="Productmarket_labqie_con2"
                      :style="
                        sel_value.target.all_muri_value == 5
                          ? click_css_gun_y
                          : click_css_gun_n
                      "
                    >  <!-- 旧品的 -->
                      <span :class="sel_value.target.all_muri_value == 5? 'title_change':''" :style="sum_zhibiao.title">{{
                        sel_title.chanzhi_wenzi.title_oldpro
                      }}</span>

                      <span :style="sum_zhibiao.zhognxin"> 
                        {{
                          (sel_value.Range_on.Range_set=='5')? fomatMoney((sel_title_setvalue.quota_value.cont13*1).toFixed(1))+'元':

                          (sel_value.Range_on.Range_set=='4')?
                          (sel_title_setvalue.quota_value.cont13*100).toFixed(2)+'%':
                          (sel_value.Range_on.Range_set=='2')?
                          fomatMoney(((sel_title_setvalue.quota_value.cont13/10000)/10000).toFixed(2))+'亿':
                          fomatMoney((sel_title_setvalue.quota_value.cont13/10000).toFixed(1))+'万'
                          }} </span>
                      ...
                      <span :style="sum_zhibiao.body">
                        <i
                          ...
                          >{{ sel_title.chanzhi_wenzi.reach_rate }}</i
                        >
                        <i style="font-style: normal"> {{(sel_title_setvalue.quota_value.cont14==0)? '--':
                          (sel_value.Range_on.Range_set=='5')? fomatMoney((sel_title_setvalue.quota_value.cont14*1).toFixed(1))+'元':

                          (sel_value.Range_on.Range_set=='2')? 
                          (sel_title_setvalue.quota_value.cont14/10000/10000).toFixed(2)+'亿':
                          (sel_title_setvalue.quota_value.cont14/10000).toFixed(1)+'万'}} </i>
                      </span>
                      <span class="tongbi_css" :style="sum_zhibiao.body">
                        <i
                          style="
                        ...
                        :style="(sel_value.Range_on.Range_set=='4'&&sel_title_setvalue.quota_value.cont15==0)?{'padding-left': '0px'}:{'padding-left': '3px'}"
                          :class="
                            Number(
                                sel_title_setvalue.quota_value.cont15
                              ) > 0
                            ? 'rate-up'
                            : 'rate-down'
                          "
                        >
                          {{
                            (sel_value.Range_on.Range_set=='3')?
                            (sel_title_setvalue.quota_value.cont15/10000).toFixed(1)+'万'
                            :
                            (sel_value.Range_on.Range_set=='4'&&sel_title_setvalue.quota_value.cont15==0)?
                            '--'
                            :
                            (sel_title_setvalue.quota_value.cont15*100).toFixed(1)+'%'
                          }}</i
                        >
                      </span>
                    </div>
                  ...
                  <swiper-slide >
                    ...
                    >
                      ...
                      <span :style="sum_zhibiao.zhognxin"> 
                        {{
                          (sel_value.Range_on.Range_set=='5')? fomatMoney((sel_title_setvalue.quota_value.cont4*1).toFixed(1))+'元':

                          (sel_value.Range_on.Range_set=='4')?
                          (sel_title_setvalue.quota_value.cont4*100).toFixed(2)+'%':
                          (sel_value.Range_on.Range_set=='2')?
                          fomatMoney(((sel_title_setvalue.quota_value.cont4/10000)/10000).toFixed(2))+'亿':
                          fomatMoney((sel_title_setvalue.quota_value.cont4/10000).toFixed(1))+'万'
                          }} </span>
                      ...
                      <span :style="sum_zhibiao.body">
                        ...
                        <i style="font-style: normal"> {{(sel_title_setvalue.quota_value.cont5==0)? '--':
                          (sel_value.Range_on.Range_set=='5')? fomatMoney((sel_title_setvalue.quota_value.cont5*1).toFixed(1))+'元':

                          (sel_value.Range_on.Range_set=='2')? 
                          (sel_title_setvalue.quota_value.cont5/10000/10000).toFixed(2)+'亿':
                          (sel_title_setvalue.quota_value.cont5/10000).toFixed(1)+'万'}} </i>
                      </span>
                      <span class="tongbi_css" :style="sum_zhibiao.body">
                        <i
                          style="
                        ...
                        >
                          {{
                            (sel_value.Range_on.Range_set=='3')?
                            (sel_title_setvalue.quota_value.cont6/10000).toFixed(1)+'万'
                            :
                            (sel_value.Range_on.Range_set=='4'&&sel_title_setvalue.quota_value.cont6==0)?
                            '--'
                            :
                            (sel_title_setvalue.quota_value.cont6*100).toFixed(1)+'%'
                          }}</i
                        >
                      </span>
                    </div>
                    ...
                    <div
                      ...
                      :style="
                        sel_value.target.all_muri_value == 3
                          ? Object.assign({}, click_css_gun_y, { 'margin-right': '0%' })
                          : Object.assign({}, click_css_gun_n, { 'margin-right': '0%' })
                      "
                    >
                      ...
                      <span :style="sum_zhibiao.zhognxin"> 
                        {{
                        (sel_value.Range_on.Range_set=='5')? fomatMoney((sel_title_setvalue.quota_value.cont7*1).toFixed(1))+'元':
                        (sel_value.Range_on.Range_set=='4')?
                        (sel_title_setvalue.quota_value.cont7*100).toFixed(2)+'%':
                        (sel_value.Range_on.Range_set=='2')?
                        fomatMoney(((sel_title_setvalue.quota_value.cont7/10000)/10000).toFixed(2))+'亿':
                        fomatMoney((sel_title_setvalue.quota_value.cont7/10000).toFixed(1))+'万'
                        }} </span>
                      ...
                      <span :style="sum_zhibiao.body">
                        ...
                        <i style="font-style: normal"> {{(sel_title_setvalue.quota_value.cont8==0)? '--':
                          (sel_value.Range_on.Range_set=='5')? fomatMoney((sel_title_setvalue.quota_value.cont8*1).toFixed(1))+'元':
                          (sel_value.Range_on.Range_set=='2')? 
                          (sel_title_setvalue.quota_value.cont8/10000/10000).toFixed(2)+'亿':
                          (sel_title_setvalue.quota_value.cont8/10000).toFixed(1)+'万'}} </i>
                      </span>
                      <span class="tongbi_css" :style="sum_zhibiao.body">
                        <i
                          style="
                        ...
                        :style="(sel_value.Range_on.Range_set=='4'&&sel_title_setvalue.quota_value.cont9==0)?{'padding-left': '0px'}:{'padding-left': '3px'}"
                          ...
                          >{{
                            (sel_value.Range_on.Range_set=='3')?
                            (sel_title_setvalue.quota_value.cont9/10000).toFixed(1)+'万'
                            :
                            (sel_value.Range_on.Range_set=='4'&&sel_title_setvalue.quota_value.cont9==0)?
                            ' --'
                            :
                            (sel_title_setvalue.quota_value.cont9*100).toFixed(1)+'%'
              ...
              <van-col span="8">
                <div>
                  <div style="margin: 0 auto; width: 50px; height: 17px;">
                    ...
                    <div style="height: 17px;font-size: 12px;"><span>当期</span></div>
                  </div>
                  <div style="text-align: center;">
                    <!-- <i style="width: 15px;height: 4px;display: block; margin-right: 6px;margin-top: 6px;float: left;"></i> -->
            ...
            <ul class="table_all">
              ...
              >
                ...
                <ul>
                  ...
                  <li>{{
                    (sel_value.Range_on.Range_set=='4')? 
                    nll_undefined(((val.PURE_NEW_PROD_AMT||0)*100).toFixed(2))+'%':
                    nll_undefined(fomatMoney(((val.PURE_NEW_PROD_AMT||0)/10000).toFixed(1)))+'万'
                    }}</li>
                  <li>{{
                    (sel_value.Range_on.Range_set=='4')? 
                    nll_undefined(((val.TGT_NEW_MTRL_ACT_PRICE||0)*100).toFixed(2))+'%':
                    (val.TGT_NEW_MTRL_ACT_PRICE==0&&sel_value.Range_on.Range_set=='3')?
                    '--'
                    :nll_undefined(fomatMoney(((val.TGT_NEW_MTRL_ACT_PRICE||0)/10000).toFixed(1)))+'万'
                    }}</li>
                  ...
                  >
                    ...
                    {{nll_undefined(((val.NEW_PROD_AMT_CPML_RTO||0)*100).toFixed(1))+'%'}}
                ...
                >
                  <ul>
                    ...
                    <li style="width: 33.33333%;">
                      ...
                      >
                        {{ ((val.PCT_COMP_RATE_PREV||0)*100).toFixed(1)+'%'}}
                      </i>
...
export default {
  ...
  created() {
    ...
    const apiMap = {
      "SQL-pds_kpi-kpi_fields": { resultProp: "kpi_fields" },  //更新时间来的
      "SQL-pds_avg_amt-tot_mtd_sum": { resultProp: "tot_mtd_sum" },      
      "SQL-pds_avg_amt-tot_mly_trend": { resultProp: "tot_mly_trend" },
      "SQL-pds_avg_amt-spl_mtd_sum": { resultProp: "spl_mtd_sum" },
      // 新加的 新品改未sku
    };
    this.ajax_data(apiMap);
  ...
  mounted() {
    ...
    this.Single_choice('cpcy', ['_this.change_text(\''+'1'+'\')'], true, '_this.sel_value.theme');
    ...
    this.p1.then(() => {
      try{
        this.data_load_time=(typeof(this.data["pds_kpi-kpi_fields"])!='undefined'&&typeof(this.data["pds_kpi-kpi_fields"][0])!='undefined')?  
          ...
          // +'.'
          // +(this.data["pds_kpi-kpi_fields"][0].LOAD_TIME).substring(11,16)          
  ...
  methods: {
    ...
    onRefresh() {
      ...
      let apiMap3 = {
        "SQL-pds_kpi-kpi_fields": { resultProp: "kpi_fields" },  //更新时间来的
        // "SQL-pds_dlvr-sku_avg_amt_mons": { resultProp: "sku_avg_amt_mons" },        
        // "SQL-pds_dlvr-sku_avg_amt": { resultProp: "sku_avg_amt" },
        // "SQL-pds_dlvr-sku_avg_amt_spl": { resultProp: "sku_avg_amt_spl" },
    ...
    change_text(value) {
      switch (value) {
        case "1":
          ...
          this.sel_title.chanzhi_wenzi.title_newpro = "新品";
          this.sel_title.chanzhi_wenzi.title_oldpro = "旧品";
    ...
    data_screen_quota(){
      ...
      this.p1.then(() => {
        ...
        this.sel_title_setvalue.quota_value.cont10=0;
        this.sel_title_setvalue.quota_value.cont11=0;
        this.sel_title_setvalue.quota_value.cont12=0;
        this.sel_title_setvalue.quota_value.cont13=0;
        this.sel_title_setvalue.quota_value.cont14=0;
        this.sel_title_setvalue.quota_value.cont15=0;
        ...
        if(this.sel_value.Range_on.Range_set=='1'){
          ...
          try{
            ...
            data=this.data["pds_avg_amt-tot_mtd_sum"][0];    
            ...
            this.sel_title_setvalue.quota_value.cont1=data.TOT_SKU_AVG_AMT;
            ...
            this.sel_title_setvalue.quota_value.cont2=data.AGO_TOT_SKU_AVG_AMT||0;
            // this.sel_title_setvalue.quota_value.cont3=data.NEW_PROD_AMT_YOY;
            this.sel_title_setvalue.quota_value.cont3=data.TOT_SKU_AVG_AMT_YOY||0;
            ...
            this.sel_title_setvalue.quota_value.cont5=data.AGO_UNSTOP_SKU_AVG_AMT||0;
            ...
            this.sel_title_setvalue.quota_value.cont8=data.AGO_STOP_SKU_AVG_AMT||0;
            ...
            // 新品
            this.sel_title_setvalue.quota_value.cont10=data.NEW_SKU_AVG_AMT||0;       //新品SKU均值
            this.sel_title_setvalue.quota_value.cont11=data.AGO_NEW_SKU_AVG_AMT||0;   //同期新品SKU均值
            this.sel_title_setvalue.quota_value.cont12=data.NEW_SKU_AVG_AMT_YOY||0;   //新品SKU均值同比


            // 旧品
            this.sel_title_setvalue.quota_value.cont13=data.OLD_SKU_AVG_AMT||0; 
            this.sel_title_setvalue.quota_value.cont14=data.AGO_OLD_SKU_AVG_AMT||0; 
            this.sel_title_setvalue.quota_value.cont15=data.OLD_SKU_AVG_AMT_YOY||0; 


  
            // data_project=this.data["pds_new_prod-spl_new_prod"]
            // data_project=this.data["pds_dlvr-sku_avg_amt_spl"];
            // { AND T.IS_STOP IN (#IS_STOP#) } -- 是否停产   
            // { AND T.IS_NEW IN (#IS_NEW#) }   -- 是否新品



            data_project=this.data["pds_avg_amt-spl_mtd_sum"];  
            Object.keys(data_project).forEach((key_index_value) => { 
              if(this.sel_value.target.all_muri_value==1){
                ...
                data_project[key_index_value].PURE_NEW_PROD_AMT=data_project[key_index_value].NEW_SKU_AVG_AMT;     
                data_project[key_index_value].TGT_NEW_MTRL_ACT_PRICE=data_project[key_index_value].NEW_SKU_AVG_AMT_AGO; 
                data_project[key_index_value].NEW_PROD_AMT_CPML_RTO=data_project[key_index_value].NEW_SKU_AVG_AMT_YOY;
              }else if(this.sel_value.target.all_muri_value==5){
                data_project[key_index_value].PURE_NEW_PROD_AMT=data_project[key_index_value].OLD_SKU_AVG_AMT;     
                data_project[key_index_value].TGT_NEW_MTRL_ACT_PRICE=data_project[key_index_value].OLD_SKU_AVG_AMT_AGO; 
                data_project[key_index_value].NEW_PROD_AMT_CPML_RTO=data_project[key_index_value].OLD_SKU_AVG_AMT_YOY;
              }
    ...
    initChart() {
      ...
      // console.log(_time_now.getMinutes());
      // console.log(new Date(" 8:30").getTime());
      ...
      // }
      // let promise=[];
      // promise=this.$axios.post(`/api/admin/data/${'pds_avg_amt'}/${'tot_mly_trend'}/get`, params).then(({ data }) => {
      //   this.data["pds_avg_amt-tot_mly_trend"]=data;
      // });
      // this.pChart= Promise.all([promise,]);
      this.pChart= Promise.all([this.p1]);
      ...
      this.pChart.then(() => {
        ...
        try{
          ...
          if(this.sel_value.Range_on.Range_set == "1"){
            ...
            user_data = this.data["pds_avg_amt-tot_mly_trend"];
            ...
            Object.keys(user_data).forEach((key_value_chart) => {
              ...
              }else if(this.sel_value.target.all_muri_value==4&&user_data[key_value_chart].MDATE.substring(0,4)==(year_now-1)+''){
                hour_data.push((user_data[key_value_chart].MDATE.substring(5, 7)*1+'月'));
                ago_amt.push((user_data[key_value_chart].NEW_SKU_AVG_AMT/10000).toFixed(1)*1);
              }else if(this.sel_value.target.all_muri_value==5&&user_data[key_value_chart].MDATE.substring(0,4)==(year_now-1)+''){
                hour_data.push((user_data[key_value_chart].MDATE.substring(5, 7)*1+'月'));
                ago_amt.push((user_data[key_value_chart].OLD_SKU_AVG_AMT/10000).toFixed(1)*1);
              }
              ...
              }else if(this.sel_value.target.all_muri_value==4&&user_data[key_value_chart].MDATE.substring(0,4)==year_now){
                sale_amt.push((user_data[key_value_chart].NEW_SKU_AVG_AMT/10000).toFixed(1)*1);
              }else if(this.sel_value.target.all_muri_value==5&&user_data[key_value_chart].MDATE.substring(0,4)==year_now){
                sale_amt.push((user_data[key_value_chart].OLD_SKU_AVG_AMT/10000).toFixed(1)*1);
              }
          ...
          if(this.sel_value.Range_on.Range_set == "1"){
            ...
            Object.keys(hour_data).forEach((key_mv) => {
              if(hour_data[key_mv]==((_time_now.getMonth()+1)+'月')){
                this.barData.value=this.fomatMoney(sale_amt[key_mv])+'元'
                this.barData.ago_value=this.fomatMoney(ago_amt[key_mv])+'元'
              }
            });  

            if(this.barData.value==0&&this.barData.ago_value==0){
              this.barData.month=hour_data[hour_data.length-1];
              this.barData.value=this.fomatMoney(sale_amt[sale_amt.length-1])+'元'
              this.barData.ago_value=this.fomatMoney(ago_amt[sale_amt.length-1])+'元'
            }
          ...
          // console.log(_time_now.getDate());
            ...
            // console.log(user_data[0].OFF_LINE_PCTAASAS);
            // this.barData.value=user_data[0].OFF_LINE_PCTAASAS;
          ...
          console.error(error);
          // this.info_error+=1;
          Information_log('产品供应-SKU均值','产品供应-SKU均值-折线图:  '+error.toString());
        }
