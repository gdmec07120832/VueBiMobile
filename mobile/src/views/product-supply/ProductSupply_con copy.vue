      ...
      <div>
        ...
        >
          ...
          >
            <div
              @click="
                Single_choice('all_muri_value', ['_this.data_screen_quota()','_this.initChart()','_this.initChart2()'], 1, '_this.sel_value.target')
              "
            ...
            >
              ...
              <span :style="sum_zhibiao.zhognxin"> 
                {{
                  ...
                  '--'
                  :
                  (sel_value.Range_on.Range_set=='5')? fomatMoney((sel_title_setvalue.quota_value.cont1*1).toFixed(1))+'元':
                  (sel_value.Range_on.Range_set=='4')?
                  (sel_title_setvalue.quota_value.cont1*100).toFixed(2)+'%' :
                  (sel_value.Range_on.Range_set=='2')?
                  fomatMoney(((sel_title_setvalue.quota_value.cont1/10000)/10000).toFixed(2))+'亿':
                  fomatMoney((sel_title_setvalue.quota_value.cont1/10000).toFixed(1))+'万'
              ...
              <span :style="sum_zhibiao.body">
                ...
                > 
                  ...
                  (sel_value.Range_on.Range_set=='5')? fomatMoney((sel_title_setvalue.quota_value.cont2*1).toFixed(1))+'元':

                  (sel_value.Range_on.Range_set=='2')? 
                  (sel_title_setvalue.quota_value.cont2/10000/10000).toFixed(2)+'亿':
                  (sel_value.Range_on.Range_set=='1')?
                  (sel_title_setvalue.quota_value.cont2/10000).toFixed(1)+'万': 
                  (sel_value.Range_on.Range_set=='4')?
                  (sel_title_setvalue.quota_value.cont2*100).toFixed(1)+'%': 
                  (sel_title_setvalue.quota_value.cont2/10000).toFixed(1)+'万'}} 
            ...
            <div
              @click="
                Single_choice('all_muri_value', ['_this.data_screen_quota()','_this.initChart()','_this.initChart2()'], 2, '_this.sel_value.target')
              "
            ...
            <div
              @click="
                Single_choice('all_muri_value', ['_this.data_screen_quota()','_this.initChart()','_this.initChart2()'], 3, '_this.sel_value.target')
              "
    ...
    this.$EventBus.$on("prosupply_choice_f", (Range_value_set) => {
      ...
      switch (Range_value_set.Range_value_set) {
        ...
        case "3":
          ...
          set_value = "muying";
          this.Single_choice(set_value, ['_this.change_text(\''+Range_value_set.Range_value_set+'\')','_this.data_screen_quota()','_this.initChart()'], true, '_this.sel_value.theme');
          Information_log('产品供应-欠货','产品供应-欠货:  '+'数据加载完成');
    ...
    initChart() {
      ...
      this.p1.then(() => {
        ...
        try{
          ...
          console.error(error);
          // this.info_error+=1;
          Information_log('产品供应','产品供应-折线图:  '+error.toString());
        }
