                  ...
                  <template> 
                    ...
                    <swiper-slide >
                      ...
                      <!-- 'display': 'inline-flex' -->
                        <div
                          class="wrapper_div1"
                          v-if="(tagonval.targetlist.PayAmt==true&&tagonval.ActiTagJsonOn.PayAmt==1)||permissionList['SQL-overview-new_data']"
                        ...
                        >
                          <span class="name" :class="'padding_10px'">
                            ...
                            <!-- <van-icon name="arrow" size="14" color="#A9A9A9" style="margin-top: 5px;float: right;margin-right: 10px;" /> -->
                        ...
                        <div
                          class="wrapper_div2"
                          v-if="(tagonval.targetlist.DelGoods==true&&tagonval.ActiTagJsonOn.DelGoods==1)||permissionList['SQL-overview-new_data']"
                        ...
                        <!-- tagonval:{
                          ProSupply:false,  //产品供应
                          ChaSal:false,     //渠道销售
                          WarLog:false,     //仓储物流
                          userval:0,
                        }, tagonval.ChaSal==true-->
                        <div 
                          v-if="tagonval.targetlist.UndcanTion==true&&tagonval.ActiTagJsonOn.UndcanTion==1"
                          :style="list[0].display1?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div1"
                          ...
                          >
                            ...
                            >
                              <!-- <span></span> -->
                              <!-- :class="calcSignClass(data['overview-cg_tar_rate'])" 累计同比：-->
                              同期差值：<i
                                style="font-style: normal"
                                :class="
                        ...
                        <!-- tagonval.userval!=1&&tagonval.userval!=2&&tagonval.userval!=3 -->
                        <div 
                          v-if="tagonval.targetlist.PurgroPmar==true&&tagonval.ActiTagJsonOn.PurgroPmar==1"
                          :style="list[1].display2?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div2"
                        ...
                        <div
                          v-if="tagonval.targetlist.Bflow==true&&tagonval.ActiTagJsonOn.Bflow==1" 
                        ...
                        <!-- tagonval:{
                          ...
                          WarLog:false,     //仓储物流
                          userval:0,
                        }, tagonval.userval==2  tagonval.ProSupply==true-->
                        <!-- 2021-01-09 新加sku值来 -->
                        <div v-if="tagonval.targetlist.SKUAverage==true&&tagonval.ActiTagJsonOn.SKUAverage==1"  
                          :style="list[2].display3?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div2"
                        ...
                        <!-- tagonval:{
                          ...
                          WarLog:false,     //仓储物流
                          userval:0,
                        }, tagonval.userval==2  tagonval.ProSupply==true||tagonval.WarLog==true-->
                        <!-- 2021-07-27 周转率开始 --> 
                        <div 
                          v-if="tagonval.targetlist.TurRat==true&&tagonval.ActiTagJsonOn.TurRat==1"
                        ...
                        <!-- tagonval:{
                          ...
                          WarLog:false,     //仓储物流
                          userval:0,
                        }, tagonval.userval==2 tagonval.WarLog==true-->
                        <!-- 2021-07-27 支装准时率结束 -->
                        <div v-if="tagonval.targetlist.OnTimeAss==true&&tagonval.ActiTagJsonOn.OnTimeAss==1"  
                          :style="list[4].display5?  { width: wrapper_con_width + 'px','display': 'inline-flex'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div2"
                        ...
                        <!-- tagonval:{
                          ...
                          WarLog:false,     //仓储物流
                          userval:0,
                        }, tagonval.userval==2  tagonval.ProSupply==true||tagonval.ChaSal==true-->
                        <!-- 2021-07-27 呆滞金额开始 -->
                        <div v-if="tagonval.targetlist.SlugAmo==true&&tagonval.ActiTagJsonOn.SlugAmo==1" 
                        ...
                        <!-- 2021-07-27 日均订单欠货开始 tagonval.ProSupply==true  &&tagonval.PageUp==false-->
                        <div v-if="tagonval.targetlist.AveDaiAge==true&&tagonval.ActiTagJsonOn.AveDaiAge==1"
                          :style="list[3].display4?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div1"
                        ...
                        <!-- 2021-07-27 售后不良率开始 tagonval.ProSupply==true||tagonval.WarLog==true &&tagonval.PageUp==false-->
                        <div v-if="tagonval.targetlist.AfSalDefRat==true&&tagonval.ActiTagJsonOn.AfSalDefRat==1" 
                          :style="list[4].display5?  { width: wrapper_con_width + 'px','display': 'inline-flex'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div2"
                        ...
                        <!-- tagonval:{
                          ...
                          WarLog:false,     //仓储物流
                          userval:0,
                        }, tagonval.userval==2  tagonval.ProSupply==true||tagonval.WarLog==true &&tagonval.PageUp==false-->
                        <div v-if="tagonval.targetlist.AftSalExp==true&&tagonval.ActiTagJsonOn.AftSalExp==1" 
                          :style="list[2].display3?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div1"
                        ...
                        <!-- tagonval:{
                          ...
                          WarLog:false,     //仓储物流
                          userval:0,
                        }, tagonval.userval==2 tagonval.ChaSal==true  &&tagonval.PageUp==false-->
                        <div v-if="tagonval.targetlist.RetExp==true&&tagonval.ActiTagJsonOn.RetExp==1"
                          :style="list[3].display4?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div2"
                        ...
                        <!-- tagonval:{
                          ...
                          WarLog:false,     //仓储物流
                          userval:0,
                        }, tagonval.userval==2 tagonval.ChaSal==true||tagonval.WarLog==true &&tagonval.PageUp==false-->
                        <div v-if="tagonval.targetlist.OveChaDif==true&&tagonval.ActiTagJsonOn.OveChaDif==1" 
                          :style="list[3].display4?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div1"
                        ...
                        <div v-if="tagonval.targetlist.BDSR==true&&tagonval.ActiTagJsonOn.BDSR==1"
                          :style="list[3].display4?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div1"
                    ...
                    <!-- 第二页 -->
                    <swiper-slide v-if="tagonval.PageUp==true" style="background: ffffff;">

                        <div v-if="tagonval.targetlist.AveDaiAge==true&&tagonval.ActiTagJsonOn.AveDaiAge==2"
                          :style="list[3].display4?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div1"
                        ...
                        <!-- 2021-07-27 售后不良率开始 tagonval.ProSupply==true||tagonval.WarLog==true-->
                        <div v-if="tagonval.targetlist.AfSalDefRat==true&&tagonval.ActiTagJsonOn.AfSalDefRat==2" 
                          :style="list[4].display5?  { width: wrapper_con_width + 'px','display': 'inline-flex'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div2"
                        ...
                        <div v-if="tagonval.targetlist.AftSalExp==true&&tagonval.ActiTagJsonOn.AftSalExp==2" 
                          :style="list[2].display3?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div1"
                        ...
                        <div v-if="tagonval.targetlist.RetExp==true&&tagonval.ActiTagJsonOn.RetExp==2"
                          :style="list[3].display4?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div2"
                        ...
                        <div v-if="tagonval.targetlist.OveChaDif==true&&tagonval.ActiTagJsonOn.OveChaDif==2" 
                          :style="list[3].display4?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div1"
                        ...
                        <div v-if="tagonval.targetlist.BDSR==true&&tagonval.ActiTagJsonOn.BDSR==2"
                          :style="list[3].display4?  { width: wrapper_con_width + 'px','display': 'inline-grid'}:{ width: wrapper_con_width + 'px','display': 'none'}"
                        >
                          <div
                            class="wrapper_div1"
                    ...
                    <div v-if="tagonval.PageUp==true" class="swiper-pagination_new swiper-pagination-bullets_new" slot="pagination">
...
export default {
    ...
    return {
      ...
      tagonval:{
        ...
        targetlist:{
          PayAmt:false,      //支付业绩
          DelGoods:false,    //发货业绩
          UndcanTion:false,  //未发取消
          PurgroPmar:false,  //采购毛利率
          Bflow:false,       //B店流量
          SKUAverage:false,  //SKU均值
          TurRat:false,      //周转率   
          OnTimeAss:false,   //支装准时率    
          SlugAmo:false,     //呆滞金额 
          AveDaiAge:false,   //日均订单欠货
          AfSalDefRat:false, //售后不良率
          AftSalExp:false,   //售后费用
          RetExp:false,      //退货费用
          OveChaDif:false,   //全渠道差评率
          BDSR:false,        //B店DSR
        },
        PageUp:false,
        signval:0,
  ...
  mounted() {
    ...
    Object.keys(this.permissionRoleList).forEach((permkey) => {
      if((this.permissionRoleList[permkey].name).indexOf("首页")>=0){
        DrawValuecon=(this.permissionRoleList[permkey].name).split("-"); 
        Object.keys(DrawValuecon).forEach((keyval) => {
          if(DrawValuecon[keyval]=='产品供应'){
            this.tagonval.ProSupply=true;
            this.tagonval.userval=1;
            console.log("首页-产品供应");
            this.tagonval.targetlist.PayAmt=true;
            this.tagonval.targetlist.DelGoods=true;
            this.tagonval.targetlist.SKUAverage=true;
            this.tagonval.targetlist.AftSalExp=true;
            this.tagonval.targetlist.AveDaiAge=true;
            this.tagonval.targetlist.TurRat=true;
            this.tagonval.targetlist.SlugAmo=true;
            this.tagonval.targetlist.AfSalDefRat=true;
          }else if(DrawValuecon[keyval]=='渠道销售'){
            this.tagonval.ChaSal=true;
            this.tagonval.userval=2;
            console.log("首页-渠道销售");
            this.tagonval.targetlist.PayAmt=true;
            this.tagonval.targetlist.DelGoods=true;
            this.tagonval.targetlist.UndcanTion=true;
            this.tagonval.targetlist.Bflow=true;
            this.tagonval.targetlist.RetExp=true;
            this.tagonval.targetlist.SlugAmo=true;
            this.tagonval.targetlist.OveChaDif=true;
            this.tagonval.targetlist.BDSR=true;
          }else if(DrawValuecon[keyval]=='仓储物流'){
            this.tagonval.WarLog=true;
            this.tagonval.userval=3;
            console.log("首页-仓储物流");
            this.tagonval.targetlist.PayAmt=true;
            this.tagonval.targetlist.DelGoods=true;
            this.tagonval.targetlist.AftSalExp=true;
            ...
            this.tagonval.targetlist.AfSalDefRat=true;
            this.tagonval.targetlist.OveChaDif=true;
            this.tagonval.targetlist.OnTimeAss=true;
            this.tagonval.targetlist.BDSR=true;
          }
        });
      }
    });
    Object.keys(this.tagonval.targetlist).forEach((setvalon) => {
      if(this.tagonval.targetlist[setvalon]==true){
        // console.log(setvalon);
        // console.log(this.tagonval.targetlist[setvalon]);
        PagePD++;
        ActiTag.push(setvalon);
        if(PagePD>8){
          ActiTagJson[setvalon]=2;
        }else{
          ActiTagJson[setvalon]=1;
        }
      }
    });
    if(ActiTag.length>8){
      this.tagonval.PageUp=true;
    }else{
      this.tagonval.PageUp=false;
    }
    this.tagonval.ActiTagJsonOn=ActiTagJson;
    // 首页权限控制结束
    
    console.log("=============asdadasfcasaaaa================");
    console.log(this.tagonval.targetlist);
    console.log((ActiTag));
    console.log(this.tagonval.ActiTagJsonOn);
    console.log(PagePD);
    console.log(this.tagonval.PageUp);
  ...
  methods: {
    ...
    JumpToPageFun(val){
      ...
      if(val=='支付业绩'){
        this.$store.commit("app/setJumpToPageVal", "支付业绩"); //store储存跳转参数
        this.$EventBus.$emit("JumpToPage_tag", {setval: 1,permission:'渠道-渠道业绩-业绩达成'});
        this.$EventBus.$emit("JumpToPageCon", {setval: 1,});        
      }else if(val=='发货业绩'){
        this.$store.commit("app/setJumpToPageVal", "发货业绩"); //store储存跳转参数
        this.$EventBus.$emit("JumpToPage_tag", {setval: 1,permission:'渠道-渠道业绩-业绩达成'});
        this.$EventBus.$emit("JumpToPageCon", {setval: 2,}); 
      }else if(val=='未发取消'){
        this.$store.commit("app/setJumpToPageVal", "未发取消"); //store储存跳转参数
        // this.$EventBus.$emit("JumpToPage_tag", {setval: 6,jumpval:2,jumpname:'ouk',permission:'渠道-渠道运营-未发取消'});
        this.$EventBus.$emit("JumpToPage_tag", {setval: 6,jumpval:4,jumpname:'pinzhi',permission:'渠道-渠道运营-未发取消'});
        // this.$EventBus.$emit("JumpToPageCon", {setval: 2,}); 
      }else if(val=='采购毛利率'){
        this.$store.commit("app/setJumpToPageVal", "采购毛利"); //store储存跳转参数
        this.$EventBus.$emit("JumpToPage_tag", {setval: 4,jumpval:1,jumpname:'cpcy',permission:'财务-财务管理-采购毛利'});
        // this.$EventBus.$emit("JumpToPage", {setval: 4,jumpval:2,jumpname:'ouk'});
      }else if(val=='SKU均值'){
        this.$store.commit("app/setJumpToPageVal", "SKU均值"); //store储存跳转参数
        // this.$EventBus.$emit("JumpToPage_tag", {setval: 2,jumpval:1,jumpname:'cpcy',permission:'产品-产品中心-SKU均值'});
        this.$EventBus.$emit("JumpToPage_tag", {setval: 2,jumpval:2,jumpname:'ouk',permission:'产品-产品中心-SKU均值'});
        // this.$EventBus.$emit("JumpToPage", {setval: 4,jumpval:2,jumpname:'ouk'});
      }else if(val=='B店流量'){
        this.$store.commit("app/setJumpToPageVal", "流量分析"); //store储存跳转参数
        // this.$EventBus.$emit("JumpToPage_tag", {setval: 6,jumpval:1,jumpname:'cpcy',permission:'渠道-渠道运营-流量分析'});
        this.$EventBus.$emit("JumpToPage_tag", {setval: 6,jumpval:2,jumpname:'ouk',permission:'渠道-渠道运营-流量分析'});
      }else if(val=='欠货'){
        this.$store.commit("app/setJumpToPageVal", "欠货"); //store储存跳转参数
        this.$EventBus.$emit("JumpToPage_tag", {setval: 2,jumpval:3,jumpname:'muying',permission:'产品-产品中心-欠货'});
        // this.$EventBus.$emit("JumpToPage", {setval: 4,jumpval:2,jumpname:'ouk'});
      }else if(val=='品质'){
        this.$store.commit("app/setJumpToPageVal", "品质"); //store储存跳转参数
        this.$EventBus.$emit("JumpToPage_tag", {setval: 2,jumpval:4,jumpname:'pinzhi',permission:'产品-产品中心-品质'});
        // this.$EventBus.$emit("JumpToPage", {setval: 4,jumpval:2,jumpname:'ouk'});
      }
