  ...
  created() {
    ...
    // if(sessionStorage.getItem("saleschan") == null){
      ...
      const apiMap = {
        ...
        // "SQL-fs_realtime-channel_type": { type: Array, resolve: resolve4 },
        // "SQL-fs_realtime-all_channel": { type: Array, resolve: resolve3 },
        // "SQL-fs_realtime-off_channel": { type: Array, resolve: resolve2 },
        ...
        // "SQL-fs_reach-pay_month_amt_down": { type: Array, resolve: resolve4 },
        // "SQL-fs_reach-pay_day_amt_down": { type: Array, resolve: resolve3 },
        // "SQL-fs_reach-dlvr_month_amt_down": { type: Array, resolve: resolve2 },
        ...
        "SQL-order_status-order_trend": { type: Array, resolve2: resolve2 },
