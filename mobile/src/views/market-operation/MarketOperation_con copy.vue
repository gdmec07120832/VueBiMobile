        ...
        <div class="Productmarket_day">
          <van-row type="flex" justify="center">
            ...
            <van-col
              ...
              span="6"
              @click="(sel_value.Range_on.Range_set=='3')? '': Single_choice('day_1',['_this.data_screen_quota()','_this.initChart2()','_this.initChart()'],true,'_this.sel_value.day_set')"
              >
              <van-button plain 
            ...
            <van-col
              ...
              span="6"
              @click="(sel_value.Range_on.Range_set=='3')? '': Single_choice('day_7',['_this.data_screen_quota()','_this.initChart2()','_this.initChart()'],true,'_this.sel_value.day_set')"
              >
              <van-button plain 
...
export default {
  ...
  created() {
    ...
    const apiMap = {
      ...
      // 未发取消
      "SQL-FS_YY_WF-BAO_BEO_TOP10_1DAY":{ resultProp: "BAO_BEO_TOP10" },
      "SQL-FS_YY_WF-SALE_RATE_1DAY":{ resultProp: "SALE_RATE" },
      "SQL-FS_YY_WF-AGO_RATE_1DAY":{ resultProp: "AGO_RATE" },
      "SQL-FS_YY_WF-AGO_AMT_1DAY":{ resultProp: "AGO_AMT" },
      "SQL-FS_YY_WF-YOY_RATE_1DAY":{ resultProp: "YOY_RATE" },
      "SQL-FS_YY_WF-AMT_1DAY":{ resultProp: "AMT" },
      "SQL-FS_YY_WF-RATE_AMT_1DAY":{ resultProp: "RATE_AMT" },
      "SQL-FS_YY_WF-RATE_TREND_1DAY":{ resultProp: "RATE_TREND" },
      ...
      "SQL-FS_YY_FX-F_VISITOR_YOY_MONTH":{ type: Array, resolve: resolve1 },
  ...
  mounted(){
    ...
    this.$EventBus.$on("Salechan_marketoper_f", (Range_value_set) => {
      ...
      if(Range_value_set.Range_value_set=='3'){
        ...
        this.Single_choice('day_1',['_this.data_screen_quota()','_this.initChart()','_this.initChart2()'],true,'_this.sel_value.day_set')
      }
    ...
    this.Single_choice('day_1',['_this.data_screen_quota()','_this.initChart2()'],true,'_this.sel_value.day_set')
  ...
  methods:{
    ...
    onConfirm(value, index) {
      ...
      this.Single_choice('month',['_this.data_screen_quota()','_this.initChart2()','_this.initChart()','_this.initChart3()'],true,'_this.sel_value.day_set')
    ...
    time_sel(val) {
      ...
      this.Single_choice('month',['_this.data_screen_quota()','_this.initChart2()','_this.initChart()'],true,'_this.sel_value.day_set')
