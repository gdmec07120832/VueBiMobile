      ...
      <div>
            ...
            <van-popup v-model="question_show" @close='showPopup_close' class="popup_css" get-container="body">
              ...
              <div style="text-align: left;font-size: 14px;padding-left: 20px;
                ...
                <van-collapse v-model="activeNames_tips" accordion>
                  <van-collapse-item title="总成本" name="1">
                    总成本=物流成本+三包成本，不包含快递、自提、补件等业务
                  </van-collapse-item>
                  <van-collapse-item title="物流成本" name="2">
                    物流成本=4PL发货通知单上的“物流成本”汇总，不包含快递、自提、补件等业务
                  </van-collapse-item>
                  <van-collapse-item title="三包成本" name="3">
                    三包成本=4PL发货通知单上的“三包成本”汇总，不包含快递、自提、补件等业务
                  </van-collapse-item>
                </van-collapse>
          ...
          <div class="Productmarket_day">
            <van-row type="flex" justify="center">
              ...
              <van-col style="margin-right: 0px;" span="6"
                ><van-button plain
                  @click="Single_choice('day_7',['_this.data_Logistics()','_this.initChart4()','_this.echarts_clear=true'],true,'_this.sel_value.day_set')"
                  :type="
              ...
              <van-col style="margin-right: 10px;margin-left: 10px;" span="6"
                ><van-button plain
                  @click="Single_choice('day_30',['_this.data_Logistics()','_this.initChart4()','_this.echarts_clear=true'],true,'_this.sel_value.day_set')"
                  :type="
        ...
        >
          ...
          >
            ...
            <div
              ...
              @click="
                Single_choice('all_muri_value',['_this.data_Logistics()','_this.initChart4()','_this.echarts_clear=true'], 1, '_this.sel_value.target')
              "            
              :style="
            ...
            >
              ...
              <span :style="sum_zhibiao.zhognxin">
                {{nll_undefined(fomatMoney(((sel_title.quota_value.cont1/10000)||0).toFixed(1)))+'万'}}
              </span>
              ...
              <span :style="sum_zhibiao.body">
                <i style="width: 55%; display: inline-block; font-style: normal"
                  >占发货比</i
                >
                <i style="font-style: normal;margin-left: -8px;">
              ...
              <span :style="sum_zhibiao.body">
                <i style="width: 55%; display: inline-block; font-style: normal"
                  >占比同比</i
                >
                <i style="font-style: normal;padding-left: 0px;margin-left: -6px;"
                :class="Number(sel_title.quota_value.cont3) > 0? 'rate-up_salesR': 'rate-down_salesR'"
                > 
            ...
            <div
              ...
              @click="
                Single_choice('all_muri_value',['_this.data_Logistics()','_this.initChart4()','_this.echarts_clear=true'], 2, '_this.sel_value.target')
              "
              :style="
            ...
            >
              <span
                ...
                >物流成本</span
              >
              <span :style="sum_zhibiao.zhognxin">{{nll_undefined(fomatMoney((sel_title.quota_value.cont4/10000||0).toFixed(1)))+'万'}}</span>
              ...
              <span :style="sum_zhibiao.body">
                ...
                >
                <i style="font-style: normal;padding-left: 0px;margin-left: -6px;"
                :class="Number(sel_title.quota_value.cont6) > 0? 'rate-up_salesR': 'rate-down_salesR'"
                > 
            ...
            <div
              @click="
                Single_choice('all_muri_value',['_this.data_Logistics()','_this.initChart4()','_this.echarts_clear=true'], 3, '_this.sel_value.target')
              "
            ...
            >
              <span
                ...
                >三包成本</span
              >
              <span :style="sum_zhibiao.zhognxin">{{nll_undefined(fomatMoney((sel_title.quota_value.cont7/10000||0).toFixed(1)))+'万'}}</span>
              ...
              <span :style="sum_zhibiao.body">
                ...
                >
                <i style="font-style: normal;padding-left: 0px;margin-left: -6px;"
                :class="Number(sel_title.quota_value.cont9) > 0? 'rate-up_salesR': 'rate-down_salesR'"
                > 
        ...
        >
          <div
            ...
            style="padding-left: 0px; padding-bottom: 0px; color: #000000"
          >
            {{ sel_value.Range_on.Range_set=='2'?'发货仓库节点时效月趋':'占发货比趋势'}}
          </div>
        </section>
        ...
        >
          ...
          <!-- 切换优化开始 -->
            ...
            <!-- 第一列开始 -->
            <div class="yjqs_clss" style="margin-bottom: 0px;display: none;">
            ...
            <!-- 第二列开始 -->
            <div class="yjqs_clss2" v-if="sel_value.qudao_guanjan_more==true" style="display: none;">
              <ul >
                <template v-for="(val, key) in sel_value.qudao_guanjan_setvalue" >
              ...
              <van-row  type="flex" justify="center" :style="canvas_qiehuan.canvas_toli_kg3==true?canvas_qiehuan.canvas_toli_cssy:canvas_qiehuan.canvas_toli_cssn">
                ...
                <van-col span="6">
                  <div>
                    ...
                    <div style="text-align: center;">
                      <!-- <i style="width: 15px;height: 4px;display: block; margin-right: 6px;margin-top: 6px;float: left;"></i> -->
                      <span style="font-size: 12px; color: #FF3300;">{{ nll_undefined(barData_lin2.month) }}</span>
                    </div> 
                  </div>
                  <!-- <div></div> -->
                </van-col>
                ...
                <van-col span="6">
                  <div>
                    <div style="margin: 0 auto; width: 55px; height: 17px;">
                      <div style="height: 17px;display: block;float: left;">
                        <div style="width: 100%; height: 8px;"></div>
                        <i style="width: 15px;height: 2px;background-color: #1678FF;display: block; margin-right: 6px;"></i>
                      </div>
                      <div style="font-size: 12px;"><span>{{(sel_value.Range_on.Range_set=='2')?'总时效':'当期'}}</span></div>
                    </div>
                    <div style="text-align: center;">
                      <span style="font-size: 12px; color: #FF3300;">{{ nll_undefined(barData_lin2.value1) }}</span>
                    </div> 
                  </div>
                </van-col>
                ...
                <van-col span="6">
                  <div>
                    <div style="margin: 0 auto; width: 55px; height: 17px;">
                      ...
                      <div style="font-size: 12px;"><span>{{(sel_value.Range_on.Range_set=='2')?'直达时效':'同期'}}</span></div>
                    </div>
                    <div style="text-align: center;">
                      <span style="font-size: 12px; color: #FF3300;">{{ nll_undefined(barData_lin2.value2) }}</span>
                    </div> 
                  </div>
                </van-col>
              ...
              >
                ...
                <van-col span="6">
                  <div>
                    ...
                    <div style="text-align: center;">
                      <!-- <i style="width: 15px;height: 4px;display: block; margin-right: 6px;margin-top: 6px;float: left;"></i> -->
                      <span style="font-size: 12px; color: #FF3300;">{{ nll_undefined(barData_lin2.value4) }}</span>
                    </div> 
                  </div>
                  <!-- <div></div> -->
                ...
                <van-col span="6">
                  <div>
                    ...
                    <div style="text-align: center;">
                      <span style="font-size: 12px; color: #FF3300;">{{ nll_undefined(barData_lin2.value5) }}</span>
                    </div> 
                  </div>
                </van-col>
                ...
                <van-col span="6">
                  <div>
                    ...
                    <div style="text-align: center;">
                      <span style="font-size: 12px; color: #FF3300;">{{ nll_undefined(barData_lin2.value6) }}</span>
                    </div> 
                  </div>
                </van-col>
                ...
                <van-col span="6">
                  <div>
                    ...
                    <div style="text-align: center;">
                      <span style="font-size: 12px; color: #FF3300;">{{ nll_undefined(barData_lin2.value7) }}</span>
                    </div> 
                  </div>
                </van-col>
              </van-row>
          ...
          <div
            ...
            style="padding-top: 0px; margin: 0 auto; padding-bottom: 10px;"
          ></div>
        </section>
        <!-- 发货仓库节点时效月趋结束 -->
...
export default {
  ...
  created() {
    ...
    const apiMap2 = {
      ...
      "SQL-LC_PL-DLVR_COST_D":{resultProp:"DLVR_COST_D"},
  ...
  methods: {
    ...
    onConfirm(value, index) {
      ...
      this.Single_choice('month',['_this.data_Logistics()','_this.initChart4()','_this.echarts_clear=true'],true,'_this.sel_value.day_set')
    ...
    data_Logistics() {
      ...
      this.p1.then(() => {
        ...
        if(this.sel_value.Range_on.Range_set=='1'){
          ...
          console.log(this.data["LC_PL-DLVR_COST_D"]);
          
          if(this.sel_value.day_set.day_7==true){
            let wlsbcb=this.data_time_select(this.data["LC_PL-DLVR_COST_D"],time_t1_on,'','TDATE_WID',8);

            console.log(wlsbcb);

            this.sel_title.quota_value.cont1 = wlsbcb.TP_TOT_FEE_7D||0;
            this.sel_title.quota_value.cont2 = wlsbcb.TP_TOT_RATE_7D||0;
            this.sel_title.quota_value.cont3 = wlsbcb.YOY_TOT_RATE_7D||0; 
            this.sel_title.quota_value.cont4 = wlsbcb.TP_LOGISTICS_FEE_7D||0;
            this.sel_title.quota_value.cont5 = wlsbcb.TP_LOGISTICS_RATE_7D||0;
            this.sel_title.quota_value.cont6 = wlsbcb.YOY_LOGISTICS_RATE_7D||0;
            this.sel_title.quota_value.cont7 = wlsbcb.TP_3S_FEE_7D||0;
            this.sel_title.quota_value.cont8 = wlsbcb.TP_3S_RATE_7D||0;
            this.sel_title.quota_value.cont9 = wlsbcb.YOY_3S_RATE_7D||0;

          }else if(this.sel_value.day_set.day_30==true){
            
            let wlsbcb=this.data_time_select(this.data["LC_PL-DLVR_COST_D"],time_t1_on,'','TDATE_WID',8);
            
            // this.sel_title.quota_value.cont1 = wlsbcb.TP_TOT_FEE_30D||0;
            // this.sel_title.quota_value.cont2 = 0;
            // this.sel_title.quota_value.cont3 = wlsbcb.YOY_DIFF_TOT_FEE_30D||0; 
            // this.sel_title.quota_value.cont4 = wlsbcb.TP_LOGISTIC_FEE_30D||0;
            // this.sel_title.quota_value.cont5 = 0;
            // this.sel_title.quota_value.cont6 = wlsbcb.YOY_DIFF_LOGISTIC_FEE_30D||0;
            // this.sel_title.quota_value.cont7 = wlsbcb.TP_3S_FEE_30D||0;
            // this.sel_title.quota_value.cont8 = 0;
            // this.sel_title.quota_value.cont9 = wlsbcb.YOY_DIFF_3S_FEE_30D||0;

            this.sel_title.quota_value.cont1 = wlsbcb.TP_TOT_FEE_30D||0;
            this.sel_title.quota_value.cont2 = wlsbcb.TP_TOT_RATE_30D||0;
            this.sel_title.quota_value.cont3 = wlsbcb.YOY_TOT_RATE_30D||0; 
            this.sel_title.quota_value.cont4 = wlsbcb.TP_LOGISTICS_FEE_30D||0;
            this.sel_title.quota_value.cont5 = wlsbcb.TP_LOGISTICS_RATE_30D||0;
            this.sel_title.quota_value.cont6 = wlsbcb.YOY_LOGISTICS_RATE_30D||0;
            this.sel_title.quota_value.cont7 = wlsbcb.TP_3S_FEE_30D||0;
            this.sel_title.quota_value.cont8 = wlsbcb.TP_3S_RATE_30D||0;
            this.sel_title.quota_value.cont9 = wlsbcb.YOY_3S_RATE_30D||0;


          }else if(this.sel_value.day_set.month==true){


            let wlsbcb=this.data_time_select(this.data["LC_PL-DLVR_COST"],(set_time_month.substring(0,4)+''+set_time_month.substring(5,7)),'','TMONTH_WID',6);

            this.sel_title.quota_value.cont1 = wlsbcb.TM_TOT_FEE||0;
            this.sel_title.quota_value.cont2 = wlsbcb.TP_TOT_RATE||0;
            this.sel_title.quota_value.cont3 = wlsbcb.YOY_TOT_RATE||0; 
            this.sel_title.quota_value.cont4 = wlsbcb.TM_LOGISTIC_DLVR_FEE||0;
            this.sel_title.quota_value.cont5 = wlsbcb.TP_LOGISTICS_RATE||0;
            this.sel_title.quota_value.cont6 = wlsbcb.YOY_LOGISTICS_RATE||0;
            this.sel_title.quota_value.cont7 = wlsbcb.TM_THREE_SERVICE_FEE||0;
            this.sel_title.quota_value.cont8 = wlsbcb.TP_3S_RATE||0;
            this.sel_title.quota_value.cont9 = wlsbcb.YOY_3S_RATE||0;
      ...
      this.p1.then(() => {
          ...
          if(this.sel_value.Range_on.Range_set=='1'){
            ...
            if(this.sel_value.day_set.day_7==true||this.sel_value.day_set.day_30==true){
              // user_data=this.data["LC_PL-DLVR_COST_D"];
              user_data=this.data_time_select(this.data["LC_PL-DLVR_COST_D"],time_set_on,'push','TDATE_WID',8,time_t1_on_userday);
              ...
              if(this.sel_value.target.all_muri_value==1){
                Object.keys(user_data).forEach((key_mv2) => {
                  hour_data.push(user_data[key_mv2].TDATE_WID.substring(4,6)+'.'+user_data[key_mv2].TDATE_WID.substring(6,8));
                  year_add_time.push(user_data[key_mv2].TDATE_WID.substring(0,4));  
                  zd_amt.push(((user_data[key_mv2].TP_TOT_RATE*100)||0).toFixed(1));
                  zy_amt.push(((user_data[key_mv2].LY_TOT_RATE*100)||0).toFixed(1));
                });
              }else if(this.sel_value.target.all_muri_value==2){
                Object.keys(user_data).forEach((key_mv2) => {
                  hour_data.push(user_data[key_mv2].TDATE_WID.substring(4,6)+'.'+user_data[key_mv2].TDATE_WID.substring(6,8));
                  year_add_time.push(user_data[key_mv2].TDATE_WID.substring(0,4));  
                  zd_amt.push(((user_data[key_mv2].TP_LOGISTICS_RATE*100)||0).toFixed(1));
                  zy_amt.push(((user_data[key_mv2].LY_LOGISTICS_RATE*100)||0).toFixed(1));
                });
              }else if(this.sel_value.target.all_muri_value==3){
                Object.keys(user_data).forEach((key_mv2) => {
                  hour_data.push(user_data[key_mv2].TDATE_WID.substring(4,6)+'.'+user_data[key_mv2].TDATE_WID.substring(6,8));
                  year_add_time.push(user_data[key_mv2].TDATE_WID.substring(0,4));  
                  zd_amt.push(((user_data[key_mv2].TP_3S_RATE*100)||0).toFixed(1));
                  zy_amt.push(((user_data[key_mv2].LY_3S_RATE*100)||0).toFixed(1));
                });
              }
              ...
              // console.log(this.data["LC_PL-DLVR_COST"]);
              user_data=this.data_time_select(this.data["LC_PL-DLVR_COST"],this.set_time.toString(0,4),'push','TMONTH_WID',4);
              ...
              if(this.sel_value.target.all_muri_value==1){
                Object.keys(user_data).forEach((key_mv2) => {
                  ...
                  year_add_time.push(user_data[key_mv2].TMONTH_WID.substring(0,4));  
                  zd_amt.push(((user_data[key_mv2].TP_TOT_RATE*100)||0).toFixed(1));
                  zy_amt.push(((user_data[key_mv2].LY_TOT_RATE*100)||0).toFixed(1));
                });
              }else if(this.sel_value.target.all_muri_value==2){
            ...
            //   console.log("集团");
            //   Object.keys(user_data).forEach((key_mv2) => {
            //     if(user_data[key_mv2].TMONTH_WID.substring(0,4)==(this.set_time.substring(0,4))&&user_data[key_mv2].CHANNEL_NAME=='集团'){
            //         hour_data.push(user_data[key_mv2].TMONTH_WID.substring(4,6)*1+'月');
            ...
            //   console.log("平台");
            //   Object.keys(user_data).forEach((key_mv2) => {
            //     if(user_data[key_mv2].TMONTH_WID.substring(0,4)==(this.set_time.substring(0,4))&&user_data[key_mv2].CHANNEL_NAME=='平台'){
            //         hour_data.push(user_data[key_mv2].TMONTH_WID.substring(4,6)*1+'月');
            //         zd_amt.push(((user_data[key_mv2].TOT_FEE/10000)||0).toFixed(1));
            //         zy_amt.push(((user_data[key_mv2].LOGISTIC_DLVR_FEE/10000)||0).toFixed(1));
            //         jh_amt.push(((user_data[key_mv2].THREE_SERVICE_FEE/10000)||0).toFixed(1));
            ...
            //   console.log("直营");
            //   Object.keys(user_data).forEach((key_mv2) => {
            //     if(user_data[key_mv2].TMONTH_WID.substring(0,4)==(this.set_time.substring(0,4))&&user_data[key_mv2].CHANNEL_NAME=='直营'){
            //         hour_data.push(user_data[key_mv2].TMONTH_WID.substring(4,6)*1+'月');
            //         zd_amt.push(((user_data[key_mv2].TOT_FEE/10000)||0).toFixed(1));
            //         zy_amt.push(((user_data[key_mv2].LOGISTIC_DLVR_FEE/10000)||0).toFixed(1));
            //         jh_amt.push(((user_data[key_mv2].THREE_SERVICE_FEE/10000)||0).toFixed(1));
            ...
            //   console.log("采购经销");
            //   Object.keys(user_data).forEach((key_mv2) => {
            //     if(user_data[key_mv2].TMONTH_WID.substring(0,4)==(this.set_time.substring(0,4))&&user_data[key_mv2].CHANNEL_NAME=='采购经销'){
            //         hour_data.push(user_data[key_mv2].TMONTH_WID.substring(4,6)*1+'月');
            //         zd_amt.push(((user_data[key_mv2].TOT_FEE/10000)||0).toFixed(1));
            //         zy_amt.push(((user_data[key_mv2].LOGISTIC_DLVR_FEE/10000)||0).toFixed(1));
            //         jh_amt.push(((user_data[key_mv2].THREE_SERVICE_FEE/10000)||0).toFixed(1));
            ...
            //   console.log("返点经销");
            //   Object.keys(user_data).forEach((key_mv2) => {
            //     if(user_data[key_mv2].TMONTH_WID.substring(0,4)==(this.set_time.substring(0,4))&&user_data[key_mv2].CHANNEL_NAME=='返点经销'){
            //         hour_data.push(user_data[key_mv2].TMONTH_WID.substring(4,6)*1+'月');
            //         zd_amt.push(((user_data[key_mv2].TOT_FEE/10000)||0).toFixed(1));
            //         zy_amt.push(((user_data[key_mv2].LOGISTIC_DLVR_FEE/10000)||0).toFixed(1));
            //         jh_amt.push(((user_data[key_mv2].THREE_SERVICE_FEE/10000)||0).toFixed(1));
            ...
            //   console.log("海外经销");
            //   Object.keys(user_data).forEach((key_mv2) => {
            //     if(user_data[key_mv2].TMONTH_WID.substring(0,4)==(this.set_time.substring(0,4))&&user_data[key_mv2].CHANNEL_NAME=='海外经销'){
            //         hour_data.push(user_data[key_mv2].TMONTH_WID.substring(4,6)*1+'月');
            //         zd_amt.push(((user_data[key_mv2].TOT_FEE/10000)||0).toFixed(1));
            //         zy_amt.push(((user_data[key_mv2].LOGISTIC_DLVR_FEE/10000)||0).toFixed(1));
            //         jh_amt.push(((user_data[key_mv2].THREE_SERVICE_FEE/10000)||0).toFixed(1));   
            ...
            //   console.log("林氏经销");
            //   Object.keys(user_data).forEach((key_mv2) => {
            //     if(user_data[key_mv2].TMONTH_WID.substring(0,4)==(this.set_time.substring(0,4))&&user_data[key_mv2].CHANNEL_NAME=='林氏经销摆场'){
            //         hour_data.push(user_data[key_mv2].TMONTH_WID.substring(4,6)*1+'月');
            //         zd_amt.push(((user_data[key_mv2].TOT_FEE/10000)||0).toFixed(1));
            //         zy_amt.push(((user_data[key_mv2].LOGISTIC_DLVR_FEE/10000)||0).toFixed(1));
            //         jh_amt.push(((user_data[key_mv2].THREE_SERVICE_FEE/10000)||0).toFixed(1)); 
            ...
            // if(this.sel_value.day_set.day_7==true||this.sel_value.day_set.day_30==true){
            //   this.barData_lin2.month=hour_data[hour_data.length-1];
            //   this.barData_lin2.value1=zd_amt[zd_amt.length-1]+('%');
            //   this.barData_lin2.value2=zy_amt[zy_amt.length-1]+('%');
            // }else{
            //   let month_on=(((_time_now.getMonth()+1)>9)?(_time_now.getMonth()+1):'0'+(_time_now.getMonth()+1));
            //   this.barData_lin2.month=(_time_now.getFullYear())+'.'+month_on;
            //   Object.keys(hour_data).forEach((key_mv) => {
            //     if(hour_data[key_mv]==((_time_now.getMonth()+1)+'月')){
            //       this.barData_lin2.value1=zd_amt[key_mv]+('%');
            //       this.barData_lin2.value2=zy_amt[key_mv]+('%');
            //     }    
            //   });  
            // }
            ...
            if(this.sel_value.day_set.day_7==true||this.sel_value.day_set.day_30==true){
              ...
              this.barData_lin2.month=((hour_data[hour_data.length-1].substring(0,2)=='12'&&year_add_time.length>1)?year_add_time[0]-1:year_add_time[0])+'.'+hour_data[hour_data.length-1];
              this.barData_lin2.value1=zd_amt[zd_amt.length-1]+('%');
              this.barData_lin2.value2=zy_amt[zy_amt.length-1]+('%');
          ...
          // Object.keys(hour_data).forEach((key_mv) => {
          //   if(hour_data[key_mv]==((_time_now.getMonth()+1)+'月')){
          //     this.barData_lin2.value1=zd_amt[key_mv]+('万');
          //     this.barData_lin2.value2=zy_amt[key_mv]+('万');
          //     this.barData_lin2.value3=jh_amt[key_mv]+('万');
          //   }    
          // });  
            ...
            tooltip: {
              ...
              formatter:function (params) {
                ...
                if(_this.sel_value.day_set.month==true){
                  _this.barData_lin2.month =(params[0]==undefined)? 0: year_add_time[0]+'.'+
                  ...
                  _this.barData_lin2.month =(params[0]==undefined)? 0: year_set_on+'.'+params[0].axisValue;
                }
