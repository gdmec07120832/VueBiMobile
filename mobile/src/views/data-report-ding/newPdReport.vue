...
export default {
  ...
  methods: {
    ...
    queryMainSkuSum(dateString) {
      this.$axios.get('api/admin/biNewProductsReport/queryMainSkuSum', {
        params: {
          dateStr: dateString,
          type: 2
        },
    ...
    querySaleDivide(dateString) {
      this.$axios.get('api/admin/biNewProductsReport/querySaleDivide', {
        params: {
          dateStr: dateString
        },
      }).then(res => {
    ...
    queryRecentSum(dateString) {
      this.$axios.get('api/admin/biNewProductsReport/queryRecentSum', {
        params: {
          dateStr: dateString
        },
      }).then(res => {
    ...
    queryNewSales(dateString, rowNum, week) {
      return new Promise((resolve) => {
        this.$axios.get('api/admin/biNewProductsReport/queryNewSales', {
