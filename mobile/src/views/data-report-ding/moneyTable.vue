...
export default {
  ...
  methods: {
    getDetailData (date) {
      this.$axios.get('api/admin/biProjectBReport/getDetail', {
        params: { 'dateStr': date }
      }).then(res => {
        this.dataMsg = [
          [
        ...
        //获取净业绩图表数据
        return this.$axios.get('api/admin/biProjectBReport/getList1').then(res => {
          let timeDate = []
          let numData = []
        ...
        //获取未发取消图表数据
        return this.$axios.get('api/admin/biProjectBReport/getList2').then(res => {
          let timeDate = []
          let numData = []
          for (let i = res.data.length - 1; i >= 0; i--) {
            timeDate.push(res.data[i].value)
        ...
        //获取客单价图表数据
        return this.$axios.get('api/admin/biProjectBReport/getList3').then(res => {
          let timeDate = []
          let numData = []
          for (let i = res.data.length - 1; i >= 0; i--) {
            timeDate.push(res.data[i].value)
