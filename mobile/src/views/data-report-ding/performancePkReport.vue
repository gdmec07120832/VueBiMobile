...
export default {
  ...
  methods: {
    ...
    querySumRate(dateString) {
      this.$axios.get('/api/admin//biDeliveryReport/querySumRate', {
        params: {
          dateStr: dateString
        }
      }).then(res => {
    ...
    queryRegionMes(dateString, rowNum) {
      return new Promise((resolve, reject) => {
        this.$axios.get('api/admin/biDeliveryReport/queryRegionMes', {
          params: {
            dateStr: dateString,
            rownum: rowNum
          },
    ...
    queryAreaMes(dateString, rowNum) {
      return new Promise((resolve, reject) => {
        this.$axios.get('api/admin/biDeliveryReport/queryAreaMes', {
