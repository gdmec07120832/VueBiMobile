...
export default {
  ...
  methods: {
    getData(dateString) {
      ...
      this.$axios.get('api/admin/biDeliveryReport/getBaseData', {
      ...
      this.$axios.get('api/admin/biDeliveryReport/getBiPendingTrial', {
        params: { dateStr: dateString },
      }).then(res => {
        let labelRet = [];
        let dataRet = [];
      ...
      this.$axios.get('api/admin/biDeliveryReport/getMatchingRate', {
        params: { dateStr: dateString },
      }).then(res => {
        let labelRet = [];
        let jjdataRet = [];
