      ...
      <div>
        <van-row type="flex" justify="center" style="height:20px;font-size: 0.7rem;color: #313131;padding-top:10px;margin-bottom: 5px;">
          <van-col span="12" style="display: flex;margin-left: 10px;align-items: center;justify-content: flex-start;">
            <div style="display: flex;align-items: center;">近14天待货审金额</div>
          </van-col>
    ...
    <div class="content" style="margin-top: 10px;height:275px;">
      <div>
        <van-row type="flex" justify="center" align="center" style="height:20px;font-size: 0.7rem;color: #313131;padding-top:10px;">
          <van-col span="12" style="display: flex;margin-left: 10px;align-items: center;justify-content: flex-start;">
            <div style="display: flex;align-items: center;">14天内两库-匹配率
            </div>
          </van-col>
...
export default {
  ...
  methods: {
    getData(dateString) {
      ...
      this.$axios.get('api/admin/biDeliveryReport/getBaseData2', {
      ...
      this.$axios.get('api/admin/biDeliveryReport/getBiPendingTrial2', {
        params: { dateStr: dateString },
      }).then(res => {
        let labelRet = [];
        let dataRet = [];
        ...
        this.$message.error('近14天待货审异常：' + (error.message || error.msg));
        this.dhsHidden = false;
      });
      this.$axios.get('api/admin/biDeliveryReport/getMatchingRate2', {
        params: { dateStr: dateString },
      }).then(res => {
        let labelRet = [];
        let jjdataRet = [];
        ...
        grid: {
          ...
          tooltip: {
            ...
            formatter:function (params) {
              return "日期："+params[0].axisValue+'<br/> 待货审金额：'+params[0].marker+params[0].value.toFixed(1)+'万';
            }
          },
