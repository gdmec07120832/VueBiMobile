...
export default {
  ...
  methods: {
    ...
    queryMainSum(dateString) {
      this.$axios.get('api/admin/biNewProductsReport/queryMainSum', {
        params: {
          dateStr: dateString
        },
      }).then(res => {
    ...
    querySkuSum(dateString) {
      this.$axios.get('api/admin/biNewProductsReport/querySkuSum', {
        params: {
          dateStr: dateString
        },
      }).then(res => {
    ...
    queryOldSales(dateString, rowNum, week) {
      return new Promise((resolve, reject) => {
        this.$axios.get('api/admin/biNewProductsReport/queryOldSales', {
          params: {
            dateStr: dateString,
            period: week,
            rownum: rowNum
