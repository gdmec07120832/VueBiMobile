  ...
  <div class="box" style="font-family:'Microsoft YaHei';letter-spacing: 1px;">
        ...
        <div>
          ...
          <div class="content_div">
            <div class="content_flex">
              <div style="color:#000000;" class="num_text">{{form.oldMtrlOflAmt30 === 0?'--':form.oldMtrlOflAmt30}}</div>
              <div class="title_text">30天前上架</div>
            </div>
            <div class="content_flex">
              <div style="color:#000000;" class="num_text">{{form.oldMtrlOflAmt60 === 0?'--':form.oldMtrlOflAmt60}}</div>
              <div class="title_text">60天前上架</div>
            </div>
            <div class="content_flex">
              <div style="color:#000000;" class="num_text">{{form.oldMtrlOflAmt90 === 0?'--':form.oldMtrlOflAmt90}}</div>
          ...
          <div class="content_div">
            <div class="content_flex">
              <div style="color:#000000;" class="num_text">{{form.oldMtrlOlAmt30 === 0?'--':form.oldMtrlOlAmt30}}</div>
              <div class="title_text">30天前上架</div>
            </div>
            <div class="content_flex">
              <div style="color:#000000;" class="num_text">{{form.oldMtrlOlAmt60 === 0?'--':form.oldMtrlOlAmt60}}</div>
              <div class="title_text">60天前上架</div>
            </div>
            <div class="content_flex">
              <div style="color:#000000;" class="num_text">{{form.oldMtrlOlAmt90 === 0?'--':form.oldMtrlOlAmt90}}</div>
              <div class="title_text">90天前上架</div>
            </div>
          </div>
          <div style="display: flex;height: 40px;align-items: center;font-size: 12px;">
          ...
          <div class="content_div">
            <div class="content_flex">
              <div style="color:#000000;" class="num_text">{{form.oldMtrlQty30 === 0?'--':form.oldMtrlQty30}}</div>
              <div class="title_text">30天前上架</div>
            </div>
            <div class="content_flex">
              <div style="color:#000000;" class="num_text">{{form.oldMtrlQty60 === 0?'--':form.oldMtrlQty60}}</div>
              <div class="title_text">60天前上架</div>
            </div>
            <div class="content_flex">
              <div style="color:#000000;" class="num_text">{{form.oldMtrlQty90 === 0?'--':form.oldMtrlQty90}}</div>
              <div class="title_text">90天前上架</div>
            </div>
          </div>
        </div>
    ...
    <van-dialog v-model="show" :close-on-click-overlay="true" :show-confirm-button="false" title="逻辑说明">
      <div style="padding: 10px;line-height: 20px;color: #646566;margin-bottom: 10px;font-size:12px;padding-left: 18px;padding-right: 18px;">
        <p style="padding: 3px;">1、主型号销额：旧品升级主型号近一月实际售价（剔除未发取消）；</p>
...
export default {
  ...
  data () {
    return {
      ...
      chartHidden3: true,
      form: {
        oldMtrlOflAmt30: 0, // 30天内线下业绩
        oldMtrlOflAmt60: 0, // 60天内线下业绩
        oldMtrlOflAmt90: 0, // 90天内线下业绩
        oldMtrlOlAmt30: 0, // 30天内线上业绩
        oldMtrlOlAmt60: 0, // 60天内线上业绩
        oldMtrlOlAmt90: 0, // 90天内线上业绩
        oldMtrlQty30: 0, // 30天内SKU数量
        oldMtrlQty60: 0, // 60天内SKU数量
        oldMtrlQty90: 0 // 90天内SKU数量
      },
      orgObj: {
        labelList: [],
        dataOnlineList: [],
  ...
  methods: {
    ...
    getData(dateString) {
      ...
      this.$axios.get('api/admin/biNewProductsReport/getOldLevelSummary', {
    ...
    getBeforeDate30(dateString, rownum) {
      this.$axios.get('api/admin/biNewProductsReport/getOldLevelDetails', {
        params: {
          dateStr: dateString,
          rownum: rownum,
          orderStr: '30'
        ...
        if (res.data.length > 0) {
          res.data.forEach((item, index) => {
            ...
            dataRetOnline.push(item.oldMtrlOlAmt30);
            dataRetOffline.push(item.oldMtrlOflAmt30);
            oldProdOlAmt30.push(item.oldProdOlAmt30);
            oldProdOlAmt60.push(item.oldProdOlAmt60);
            oldProdOlAmt90.push(item.oldProdOlAmt90);
            oldProdOflAmt30.push(item.oldProdOflAmt30);
            oldProdOflAmt60.push(item.oldProdOflAmt60);
            oldProdOflAmt90.push(item.oldProdOflAmt90);
          });
          this.orgObj.labelList = labelRet;
          this.orgObj.dataOnlineList = dataRetOnline;
          this.orgObj.dataOfflineList = dataRetOffline;
          this.setPendingData(labelRet, dataRetOnline, dataRetOffline, oldProdOlAmt30, oldProdOlAmt60, oldProdOlAmt90, oldProdOflAmt30, oldProdOflAmt60, oldProdOflAmt90);
        } else {
    ...
    setPendingData(label, onlineData, offlineData, oldProdOlAmt30, oldProdOlAmt60, oldProdOlAmt90, oldProdOflAmt30, oldProdOflAmt60, oldProdOflAmt90) {
      ...
      this.orgOptions = {
        tooltip: {
          confine: true,
          formatter(params) {
            if (oldProdOlAmt30[params.dataIndex] == 0) {
              oldProdOlAmt30[params.dataIndex] = '0.0';
            }
            if (oldProdOlAmt60[params.dataIndex] == 0) {
              oldProdOlAmt60[params.dataIndex] = '0.0';
            }
            if (oldProdOlAmt90[params.dataIndex] == 0) {
              oldProdOlAmt90[params.dataIndex] = '0.0';
            }
            if (oldProdOflAmt30[params.dataIndex] == 0) {
              oldProdOflAmt30[params.dataIndex] = '0.0';
            }
            if (oldProdOflAmt60[params.dataIndex] == 0) {
              oldProdOflAmt60[params.dataIndex] = '0.0';
            }
            if (oldProdOflAmt90[params.dataIndex] == 0) {
              oldProdOflAmt90[params.dataIndex] = '0.0';
            }
    ...
    getBeforeDate60(dateString, rownum) {
      this.$axios.get('api/admin/biNewProductsReport/getOldLevelDetails', {
        ...
        if (res.data.length > 0) {
          res.data.forEach((item, index) => {
            labelRet.push(item.mainModel);
            dataRetOnline.push(item.oldMtrlOlAmt60);
            dataRetOffline.push(item.oldMtrlOflAmt60);
            oldProdOlAmt30.push(item.oldProdOlAmt30);
            oldProdOlAmt60.push(item.oldProdOlAmt60);
            oldProdOlAmt90.push(item.oldProdOlAmt90);
            oldProdOflAmt30.push(item.oldProdOflAmt30);
          ...
          this.orgObj.dataOnlineList = dataRetOnline;
          this.orgObj.dataOfflineList = dataRetOffline;
          this.setPendingData2(labelRet, dataRetOnline, dataRetOffline, oldProdOlAmt30, oldProdOlAmt60, oldProdOlAmt90, oldProdOflAmt30, oldProdOflAmt60, oldProdOflAmt90);
        } else {
    ...
    setPendingData2(label, onlineData, offlineData, oldProdOlAmt30, oldProdOlAmt60, oldProdOlAmt90, oldProdOflAmt30, oldProdOflAmt60, oldProdOflAmt90) {
      ...
      this.orgOptions2 = {
        tooltip: {
          ...
          formatter(params) {
            ...
            if (params.componentIndex == 0) {
              return '线上总额：' + params.data + '万<br/>60天前上架：' + oldProdOlAmt60[params.dataIndex] + '万<br/>30天前上架：' + oldProdOlAmt30[params.dataIndex] + '万<br/>';
            } else {
              return '线下总额：' + params.data + '万<br/>60天前上架：' + oldProdOflAmt60[params.dataIndex] + '万<br/>30天前上架：' + oldProdOflAmt30[params.dataIndex] + '万<br/>';
            }
          }
        },
        textStyle: {
    ...
    getBeforeDate90(dateString, rownum) {
      this.$axios.get('api/admin/biNewProductsReport/getOldLevelDetails', {
        ...
        if (res.data.length > 0) {
          res.data.forEach((item, index) => {
            labelRet.push(item.mainModel);
            dataRetOnline.push(item.oldMtrlOlAmt90);
            dataRetOffline.push(item.oldMtrlOflAmt90);
            oldProdOlAmt30.push(item.oldProdOlAmt30);
            oldProdOlAmt60.push(item.oldProdOlAmt60);
            oldProdOlAmt90.push(item.oldProdOlAmt90);
            oldProdOflAmt30.push(item.oldProdOflAmt30);
          ...
          this.orgObj.dataOnlineList = dataRetOnline;
          this.orgObj.dataOfflineList = dataRetOffline;
          this.setPendingData3(labelRet, dataRetOnline, dataRetOffline, oldProdOlAmt30, oldProdOlAmt60, oldProdOlAmt90, oldProdOflAmt30, oldProdOflAmt60, oldProdOflAmt90);
        } else {
    ...
    setPendingData3(label, onlineData, offlineData, oldProdOlAmt30, oldProdOlAmt60, oldProdOlAmt90, oldProdOflAmt30, oldProdOflAmt60, oldProdOflAmt90) {
      ...
      this.orgOptions3 = {
        tooltip: {
          ...
          formatter(params) {
            ...
            if (params.componentIndex == 0) {
              return '线上总额：' + params.data + '万<br/>90天前上架：' + oldProdOlAmt90[params.dataIndex] + '万<br/>60天前上架：' + oldProdOlAmt60[params.dataIndex] + '万<br/>30天前上架：' + oldProdOlAmt30[params.dataIndex] + '万<br/>';
            } else {
              return '线下总额：' + params.data + '万<br/>90天前上架：' + oldProdOflAmt90[params.dataIndex] + '万<br/>60天前上架：' + oldProdOflAmt60[params.dataIndex] + '万<br/>30天前上架：' + oldProdOflAmt30[params.dataIndex] + '万<br/>';
            }
          }
        },
        textStyle: {
