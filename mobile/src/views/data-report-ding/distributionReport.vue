...
export default {
  ...
  methods: {
    ...
    getChart (dateString) {
      this.$axios.get('api/admin/biDistributionReport/getList3', {
    ...
    getDetail (dateString) {
      this.$axios.get('api/admin/biDistributionReport/getDetail', {
        params: {
          dateStr: dateString
        },
      }).then(res => {
    ...
    getArea (dateString, area) {
      return new Promise((resolve) => {
        this.$axios.get('api/admin/biDistributionReport/getDetail2', {
          params: {
            dateStr: dateString,
            area: area
          },
    ...
    queryRegionMes (dateString, rowNum) {
      return new Promise((resolve) => {
        this.$axios.get('api/admin/biDistributionReport/getList2', {
          params: {
            dateStr: dateString,
            rownum: rowNum
          },
    ...
    queryAreaMes (dateString, rowNum) {
      return new Promise((resolve) => {
        this.$axios.get('api/admin/biDistributionReport/getList1', {
          params: {
            dateStr: dateString,
            rownum: rowNum
          },
