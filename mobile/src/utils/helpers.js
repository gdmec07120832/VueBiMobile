...
// 日志信息接口的开始
export  const  Information_log=(title_name,info_log)=>{

  // info_log=JSON.stringify(info_log);
  // console.log(typeof(info_log));
  // console.log(info_log);

    $axios.get('/api/admin/common/log/save',{params:{qualifiedName:title_name,description:info_log,logLevel:'Info',logType:'Web'}})
    .then(({success})=>{
